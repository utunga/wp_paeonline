...
Tags: real estate, everythingdir, genesis, genesiswp
Requires at least: 4.0.0
Tested up to: 4.8.3
Stable tag: 1.2.7

This plugin adds a Listings custom post type for listing all the things.

== Description ==

The Everything Directory plugin uses custom post types, custom taxonomies, and widgets to create a listings management system.
...
1. Upload the entire `everything-directory` folder to the `/wp-content/plugins/` directory
