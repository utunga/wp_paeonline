			...
			tooltip: 'Insert Parallax Shortcode',
			  onclick: function() {
				  editor.windowManager.open( {
					  ...
					  body: [
						  {type: 'container', html:'<h3 class="duck-px">Required Elements</h4><hr class="duck-px"/>'},
						  {
							  type: 'textbox',
							  name: 'image',
					  ...
					  onsubmit: function( e ) {
						  var theButton = '[dd-parallax img="' + e.data.image + '" height="' + e.data.height + '" speed="'+e.data.speed+'" z-index="'+e.data.zindex+'" position="'+e.data.position+'" offset="'+e.data.offset+'"';
						  if (e.data.mobile) {theButton += ' mobile="' + e.data.mobile + '"';}
