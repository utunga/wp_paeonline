...
<?php else: ?>
	<h2 id="create-subscription-form-tabs" class="nav-tab-wrapper wpfs-admin-form-tabs">
		...
		<a href="#create-subscription-form-tab-finance" class="nav-tab"><?php esc_html_e( 'Finance', 'wp-full-stripe' ); ?></a>
			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td>
						...
						<p class="description"><?php esc_html_e( 'Allow customers to choose how many plans they want to subscribe.', 'wp-full-stripe' ); ?></p>
					</td>
				</tr>
