...
if ( isset( $form->showAddress ) && 1 == $form->showAddress ): ?>
	...
	<?php if ( ! is_null( $view->addressSwitcher() ) ): ?>
		<div id="<?php $view->addressSwitcher()->id(); ?>" class="wpfs-form-check-group wpfs-button-group wpfs-button-group--without-space wpfs-w-40" style="display: none;">
			...
			<div class="wpfs-form-row">
				<div class="wpfs-form-col">
					<div class="wpfs-form-group">
						...
						<input id="<?php $view->shippingAddressState()->id(); ?>" name="<?php $view->shippingAddressState()->name(); ?>" type="text" class="wpfs-form-control">
					</div>
				</div>
				<div class="wpfs-form-col">
					<div class="wpfs-form-group">
